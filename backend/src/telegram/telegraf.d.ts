declare module 'telegraf/scenes/wizard/context' {
    declare class WizardContext {
        constructor(ctx: ContextMessageUpdate, steps: Middleware<ContextMessageUpdate>[])
...
declare module 'telegraf/scenes/wizard' {
    import { Middleware, ContextMessageUpdate, Middleware, ContextMessageUpdate } from 'telegraf';
